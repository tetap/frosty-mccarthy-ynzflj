...
BoxParser.initialize(),
  ...
  BoxParser.createFullBoxCtor("ccst", function (t) {
    var e = t.readUint8();
  ...
  BoxParser.createBoxCtor("cdef", function (t) {
    var e;
    for (
      this.channel_count = t.readUint16(),
  ...
  BoxParser.createFullBoxCtor("cmex", function (t) {
  ...
  BoxParser.createFullBoxCtor("cmin", function (t) {
    (this.focal_length_x = t.readInt32()),
      (this.principal_point_x = t.readInt32()),
      (this.principal_point_y = t.readInt32()),
      1 & this.flags &&
        ((this.focal_length_y = t.readInt32()),
        (this.skew_factor = t.readInt32()));
  }),
  BoxParser.createBoxCtor("cmpd", function (t) {
    for (
  ...
  BoxParser.createFullBoxCtor("mskC", function (t) {
  ...
  BoxParser.createFullBoxCtor("prdi", function (t) {
    if (
      ((this.step_count = t.readUint16()),
      (this.item_count = []),
      2 & this.flags)
    )
  ...
  (Pixel.prototype.toString = function () {
    return (
      "[row: " + this.bad_pixel_row + ", column: " + this.bad_pixel_column + "]"
    );
  }),
  BoxParser.createFullBoxCtor("sbpm", function (t) {
    var e;
    for (
    ...
    if (
      ...
      if (1 < this.num_sublayers) {
        ...
        for (e = this.num_sublayers; e <= 8 && 1 < this.num_sublayers; ++e)
          i.extract_bits(1);
        for (
          this.sublayer_level_idc = [], e = this.num_sublayers - 2;
          0 <= e;
          --e
        )
  ...
  (BoxParser.hvcCBox.prototype.write = function (t) {
    ...
    for (
      ...
      for (
        t.writeUint8(
          (this.nalu_arrays[e].completeness << 7) +
            this.nalu_arrays[e].nalu_type,
        ),
...
(ISOFile.prototype.setSegmentOptions = function (t, e, i) {
  ...
  (ISOFile.prototype.getTrackDuration = function (t) {
    return t.samples
      ? ((t = t.samples[t.samples.length - 1]).cts + t.duration) / t.timescale
      : 1 / 0;
  }),
  ...
  (ISOFile.prototype.addTrack = function (t) {
    ...
    if (void 0 !== BoxParser[e.type + "SampleEntry"]) {
      ...
      for (a in BoxParser.sampleEntryCodes)
        for (var h = BoxParser.sampleEntryCodes[a], d = 0; d < h.length; d++)
          if (-1 < h.indexOf(e.type)) {
            o = a;
            break;
          }
      switch (o) {
        case "Visual":
          r.add("vmhd").set("graphicsmode", 0).set("opcolor", [0, 0, 0]),
            ...
            e.avcDecoderConfigRecord
              ? ((n = new BoxParser.avcCBox()).parse(
                  new MP4BoxStream(e.avcDecoderConfigRecord),
                ),
                s.addBox(n))
              : e.hevcDecoderConfigRecord &&
                ((n = new BoxParser.hvcCBox()).parse(
                  new MP4BoxStream(e.hevcDecoderConfigRecord),
                ),
                s.addBox(n));
          break;
        case "Audio":
        ...
        if (
          ...
          for (o = n, t = 0; t < o.trafs.length; t++) {
            ...
            if (h.subs) {
              ...
              for (
                var g = h.first_sample_index, y = 0;
                y < h.subs.entries.length;
                y++
              )
                (g += h.subs.entries[y].sample_delta),
                  ((p = d.samples[g - 1]).subsamples =
  ...
  (ISOFile.prototype.flattenItemInfo = function () {
    ...
    if (null != i && void 0 !== i.hdlr && void 0 !== i.iinf) {
      for (d = 0; d < i.iinf.item_infos.length; d++)
        ((s = {}).id = i.iinf.item_infos[d].item_ID),
          ((t[s.id] = s).ref_to = []),
          (s.name = i.iinf.item_infos[d].item_name),
          0 < i.iinf.item_infos[d].protection_index &&
            (s.protection =
              i.ipro.protections[i.iinf.item_infos[d].protection_index - 1]),
          i.iinf.item_infos[d].item_type
            ? (s.type = i.iinf.item_infos[d].item_type)
            : (s.type = "mime"),
          (s.content_type = i.iinf.item_infos[d].content_type),
          (s.content_encoding = i.iinf.item_infos[d].content_encoding);
      if (i.grpl)
        for (d = 0; d < i.grpl.boxes.length; d++)
          (entity_group = {}),
      ...
      if (i.iloc)
        for (d = 0; d < i.iloc.items.length; d++) {
          ...
          switch (
            (0 !== r.data_reference_index &&
              ...
              (s.source = i.dinf.boxes[r.data_reference_index - 1])),
          ...
          for (s.extents = [], n = s.size = 0; n < r.extents.length; n++)
            (s.extents[n] = {}),
              (s.extents[n].offset =
      ...
      if ((i.pitm && (t[i.pitm.item_id].primary = !0), i.iref))
        for (d = 0; d < i.iref.references.length; d++)
          for (
            var a = i.iref.references[d], n = 0;
            n < a.references.length;
            n++
          )
            t[a.from_item_ID].ref_to.push({
              type: a.type,
              id: a.references[n],
            });
      if (i.iprp)
        for (var o = 0; o < i.iprp.ipmas.length; o++)
          for (var h = i.iprp.ipmas[o], d = 0; d < h.associations.length; d++) {
            var l = h.associations[d];
            if ((s = (s = t[l.id]) || e[l.id]))
              for (
                void 0 === s.properties &&
                  ((s.properties = {}), (s.properties.boxes = [])),
                  n = 0;
                n < l.props.length;
                n++
              ) {
                var p = l.props[n];
                0 < p.property_index &&
                  p.property_index - 1 < i.iprp.ipco.boxes.length &&
                  ((p = i.iprp.ipco.boxes[p.property_index - 1]),
                  (s.properties[p.type] = p),
                  s.properties.boxes.push(p));
              }
          }
    }
  }),
  ...
  (ISOFile.prototype.createFragment = function (t, e, i) {
    ...
    if (null == t)
      return this.setNextSeekPositionFromSample(r.samples[e]), null;
    e = i || new DataStream();
